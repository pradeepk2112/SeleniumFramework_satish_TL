...
public class DbProvider extends AbstractDataProvider{
	...
	public static Object[][] getDataFromDb(String sql){
		...
		final String JDBC_DRIVER = Annotations.prop.getProperty("DB_Pkg");  
		final String DB_URL = Annotations.prop.getProperty("DB_Url");

		//  Database credentials
		final String USER = Annotations.prop.getProperty("DB_User");
		final String PASS = Annotations.prop.getProperty("DB_Pwd");
